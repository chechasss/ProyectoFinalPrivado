<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/home.Master" CodeBehind="QuejaMuni.aspx.vb" Inherits="WebDIACO_V2.QuejaMuni" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Regreso" runat="server">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Quejas Municipio</li>
        </ol>
    </section>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $("#sel_Munis").change(function () {
            var IDMun = $("#sel_municipio").val();
            cargarReporte(IDMun);
        });

        function cargarReporte(strIDMuni) {
            $.ajax({
                type: "POST",
                cache: false,
                url: "Ajx/ajxFuncBD.aspx",
